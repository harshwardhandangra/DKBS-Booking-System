...
export class BookingService {
  ...
  updataeBooking(sendupdatebookingModel: any) {
    var url = 'BookingController/' + sendupdatebookingModel.bookingId;
    return this.commonService.put(url, sendupdatebookingModel);
  }
}
